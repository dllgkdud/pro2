...
<div class="container-fluid" id="content">
	<div class="row" id="content_row">
		...
		<form name="frm" id="frm" action="<%=request.getContextPath() %>/CartInsertIntoSaleCtrl" method="post" onsubmit="return payCheck(this)">
			<h3>제품 정보</h3>
			...
			<table class="table">
				<tbody>
					<tr>
						<th>배송주소</th>
						<td><input type="text" name="address1" id="address1" placeholder="기본주소 입력" class="form-control" required /><br>
						<input type="text" name="address2" id="address2" placeholder="상세주소 입력" class="form-control" required /><br>
